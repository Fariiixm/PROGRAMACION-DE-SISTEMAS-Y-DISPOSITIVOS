...
*/
void lcd_draw_keypad(int pressed);
...
/*
 Dibuja un corazon con sus pulsaciones correspondientes
 */
void lcd_draw_heartbeat(uint8 pulsaciones);
/*
 Dibuja una pisada con sus pasos correspondientes
 */
void lcd_draw_stepCounter(uint8 steps);
/*
 *
 Dibuja un cuadrado de pixeles de 16x16 en la posicion deseada
 */
void lcd_pixelart(uint16 x, uint16 y);
/*
 * Dibuja la hora en formato reloj
 */
void lcd_putHour(int h, int min);
/*
 * Dibuja un cronometro
 */
void lcd_drawTimer();
/*
 *Dibuja un reloj de arena
 */
void lcd_drawSand();
...
/*
 * Dibuja un "tick" de confirmacion
 */
void draw_tick(int x, int y);
/*
 * Dibuja un simbolo de "play"
 */
void draw_play(int x,int y);
/*
 * Dibuja un simbolo de "stop"
 */
void draw_stop(int x, int y);
/*
 * Dibuja el boton de "aceptar"
 */
void draw_aceptar();
/*
 * Dibuja un cuadrardo 4x4
 */
void tiny_pixelart(uint16 x, uint16 y);
